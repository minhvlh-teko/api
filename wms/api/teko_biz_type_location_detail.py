...
_teko_biz_type_location_detail_res = ns.model(
    'teko_biz_type_location_detail_list_res', models.TekoBizTypeLocationDetailSchema.teko_biz_type_location_detail_res
)
...
class TekoBizTypeLocationDetail(_fr.Resource):
    @ns.expect(_teko_biz_type_location_detail_req, validate=False)
